...
function Header() {
  return (
    <div className="bg-white flex flex-col md:flex-row p-6 md:p-32 h-auto md:h-screen font-bold text-xl justify-between">
    <div className="flex flex-col items-start space-y-8 md:w-1/2">
      ...
      <button className="bgcolor1 text-white rounded-lg px-4 py-2 font4 w-full"><Link to='/cart'>Purchase Now</Link></button>
    </div>
