...
import bgImage from '../assets/bg3.jpg'; // Ensure this path matches the location of your bg3.jpg file
...
function Header() {
  return (
    <div 
      ...
      style={{ backgroundImage: `url(${bgImage})` }} // Adding the background image
    >
